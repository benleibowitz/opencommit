  ...
  switch (key) {
    case CONFIG_KEYS.OCO_MODEL:
      return {
        ...
        values: {
          openai: MODEL_LIST.openai,
          anthropic: MODEL_LIST.anthropic,
          gemini: MODEL_LIST.gemini,
          groq: MODEL_LIST.groq,
          mistral: MODEL_LIST.mistral,
          deepseek: MODEL_LIST.deepseek
        }
      };
    ...
    case CONFIG_KEYS.OCO_PROMPT_MODULE:
      return {
        description: 'Prompt module for commit generation, either conventional-commit or @commitlint',
        values: ['conventional-commit', '@commitlint']
      };
    ...
    case CONFIG_KEYS.OCO_API_CUSTOM_HEADERS:
      return {
        description: 'JSON string of custom HTTP headers to include in API requests',
        values: ['JSON string of headers']
      };
